...
export default function UserButton({userData}:{userData: User}){
    ...
    return(
        <DropdownMenu>
            <DropdownMenuTrigger>
                <div className="w-9 h-9 overflow-hidden rounded-full font-mono bg-gradient-to-t from-neutral-800 to-neutral-600 flex items-center justify-center text-sm font-medium">
