        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent>
                ...
                <div className="grid grid-cols-2 w-full gap-2 mt-2">
                    {data.map((item)=>(
                        <button className={`${selected === item.id ? "border-foreground" : " border-border"} rounded-md border bg-card text-card-foreground shadow text-left p-4 flex flex-col transition-all focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:ring-2 focus-visible:ring-ring`} key={item.id}>
